...
For our experiments we simulate two different data sets and eight
...
\begin{figure}
  ...
  \subfigure[5mb data files]{\
    ...
    \includegraphics[width=3.3in, trim = 0mm 10mm 0mm 0mm, clip]{figures/time-cache-fifo-5mb.pdf}
  }
  \subfigure[25mb data files]{\
    \label{fig:time-cache-fifo-25mb}
    \includegraphics[width=3.3in, trim = 10mm 20mm 0mm 0mm, clip]{figures/time-cache-fifo-25mb.pdf}
  }
...
\begin{figure}
  ...
  \subfigure[5mb data files]{\
    ...
    \includegraphics[width=3.3in, trim = 9mm 20mm 0mm 0mm, clip]{figures/time-cache-lru-5mb.pdf}
  }
  \subfigure[25mb data files]{\
    \label{fig:time-cache-lru-25mb}
    \includegraphics[width=3.3in, trim = 10mm 20mm 0mm 0mm, clip]{figures/time-cache-lru-25mb.pdf}
  }
...
To start, we compare the execution times of the various experiment
configurations. In Figure~\ref{fig:time-cache-fifo}, we look at the eviction
storage options: {\tt S3} and {\tt None} for the distribution types using a
simple {\tt FIFO} eviction strategy. As expected, the skewed distributions
execute in significantly less time regardless of their storage options. This is
due, in both cases, to the fact that 10\% (the skewed portion upon which 90\%
of queries fall) of the key range is well within the bounds of the threshold
(300 and 50 keys accordingly). As an additional result, we do not see {\tt S3}
...
That said, the benefit with randomly distributed queries \emph{is} quite large.
...
\begin{figure}
  ...
  \subfigure[5mb data files]{\
    ...
    \includegraphics[width=3.3in, trim = 9mm 10mm 0mm 0mm, clip]{figures/missrates-cache-5mb.pdf}
  }
  \subfigure[25mb data files]{\
    \label{fig:missrates-cache-25mb}
    \includegraphics[width=3.3in, trim = 18.5mm 20mm 0mm 0mm, clip]{figures/missrates-cache-25mb.pdf}
  }
...
\begin{figure}
  ...
  \subfigure[5mb data files]{\
    ...
    \includegraphics[width=3.3in, trim = 18mm 20mm 0mm 0mm, clip]{figures/missrates-storage-5mb.pdf}
  }
  \subfigure[25mb data files]{\
    \label{fig:missrates-storage-25mb}
    \includegraphics[width=3.3in, trim = 18mm 20mm 0mm 0mm, clip]{figures/missrates-storage-25mb.pdf}
  }
...
inspect the varying missrates. As one would expect, lower missrates
...
result in lower missrates regardless of eviction strategy as the data set's
size is significantly reduced for the duration of the skewing period.

Figure~\ref{fig:missrate-cache} displays the missrates across the different
...
\begin{figure}
  ...
  \subfigure[5mb data files]{\
    ...
    \includegraphics[width=3.3in, trim = 8mm 10mm 0mm 0mm,clip]{figures/FIFOvsLRU-NoS3-5mb.pdf}
  }
  \subfigure[25mb data files]{\
    \label{fig:perf-NoS3-25mb}
    \includegraphics[width=3.3in, trim = 18.5mm 20mm 0mm 0mm,clip]{figures/FIFOvsLRU-NoS3-25mb.pdf}
  }
...
\begin{figure}
  ...
  \subfigure[5mb data files]{\
    ...
    \includegraphics[width=3.3in, trim = 18.5mm 20mm 0mm 0mm,clip]{figures/FIFOvsLRU-S3-5mb.pdf}
  }
  \subfigure[25mb data files]{\
    \label{fig:perf-S3-25mb}
    \includegraphics[width=3.3in, trim = 18.5mm 20mm 0mm 0mm,clip]{figures/FIFOvsLRU-S3-25mb.pdf}
  }
