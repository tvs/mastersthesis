...
\begin{figure}
  ...
  \subfigure[Hits on disk]{\
    ...
    \includegraphics[width=3.6in, trim = 0mm 20mm 0mm 0mm,clip]{figures/hierarchy-hits-disk.pdf}
  }\\
	\subfigure[Hits on cloud]{\
		\label{fig:hitloc-cloud}
		\includegraphics[width=3.6in, trim = 0mm 20mm 0mm 0mm,clip]{figures/hierarchy-hits-cloud.pdf}
	}
